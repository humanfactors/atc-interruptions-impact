...
# ggsave('graphs/exp1.reslag.png', plot = plot.reslag, width=3.5, height=3.5, scale = 3, units = "cm")
# ggsave('graphs/exp1.reserror.png', plot = plot.reserror, width=3.5, height=3.5, scale = 3, dpi = 300, units = "cm")
